 ...
 * constructor). The second constructor has parameters x and y of type intand it needs to initialize the
 * fields.
...
public class Programme_16_Point {
    ...
    public Programme_16_Point() {       // no Parameters constructor
        this.x = 0;
        this.y = 0;
